  ...
  return (
    <ThemedView style={styles.container}>
      <ThemedView style={styles.header}>
        ...
        <ThemedText style={[styles.headerTitle, { color: colors.text }]}>{t('home.privacyPolicy')}</ThemedText>
        <ThemedView style={styles.placeholder} />
      </ThemedView>
      <ScrollView style={styles.scroll} showsVerticalScrollIndicator={false}>
        <ThemedText style={[styles.body, { color: colors.text }]}>{PRIVACY_CONTENT.trim()}</ThemedText>
      </ScrollView>
    </ThemedView>
  );
}
